                    ...
                    <div class="col-md-6">
                         <div class="form-group">
                            ...
                            <select class="form-control" name="designation" required>
                                ...
                                <option>পিয়ন</option>
                                <option>আয়া</option>
                                <option>ট্রেড ইন্সট্রাক্টর</option>
                                <option>অফিস সহকারী</option>
                                <option>সহকারী অফিস সহকারী</option>
                                <option>বাবুর্চি</option>
                                <option>নৈশ প্রহরী</option>
                                <option>ড্রাইভার</option>
                                <option>পাহারাদার</option>
                                <option>অন্যান্য</option>
                            </select>
                        </div>
                    </div>
