                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="designation" required>
                                    ...
                                    <option <?= $result['designation'] == 'আয়া'?'selected':'' ?>   value="আয়া">আয়া</option>
                                    <option <?= $result['designation'] == 'ট্রেড ইন্সট্রাক্টর '?'selected':'' ?>   value="ট্রেড ইন্সট্রাক্টর ">ট্রেড ইন্সট্রাক্টর </option>
                                    <option <?= $result['designation'] == 'অফিস সহকারী'?'selected':'' ?>   value="অফিস সহকারী">অফিস সহকারী</option>
                                    <option <?= $result['designation'] == 'সহকারী অফিস সহকারী'?'selected':'' ?>   value="সহকারী অফিস সহকারী">সহকারী অফিস সহকারী</option>
                                    <option <?= $result['designation'] == 'বাবুর্চি'?'selected':'' ?>   value="বাবুর্চি">বাবুর্চি</option>
                                    <option <?= $result['designation'] == 'নৈশ প্রহরী'?'selected':'' ?>   value="নৈশ প্রহরী">নৈশ প্রহরী</option>
                                    <option <?= $result['designation'] == 'ড্রাইভার'?'selected':'' ?>   value="ড্রাইভার">ড্রাইভার</option>
                                    <option <?= $result['designation'] == 'পাহারাদার'?'selected':'' ?>   value="পাহারাদার">পাহারাদার</option>
