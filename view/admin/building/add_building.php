  ...
  <div class="container" style="width: 100%; background: white">
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <form action="view/admin/building/store_building.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add New Building</h3>
                <hr /> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for=""> Number of Buildings :<font color="red" size="4">*</font> </label>
                            <input type='text' id="" name="building" class="form-control" placeholder="Enter Number of Building" />
                        </div>
                    </div>  
                </div>
                <div class="row">
