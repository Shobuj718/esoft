  ...
  <div class="container" style="width: 100%; background: white">
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <form action="view/admin/class_room/store_class_room.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add New Class Room</h3>
                <hr /> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for=""> Number of Class Room :<font color="red" size="4">*</font> </label>
                            <input type='text' id="" name="class_room" class="form-control" placeholder="Enter Number of Building" />
                        </div>
                    </div>  
                </div>
                <div class="row">
