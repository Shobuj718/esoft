  ...
  <div class="container" style="width: 100%; background: white">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="view/admin/governing/store_managing.php" method="post" enctype="multipart/form-data">

                <h3 class="text-center" style="color: #2559ee">Add Commitee Information </h3>
                <hr />
                    <?php
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type='file' id="image" required name="image"  onchange="readURL2(this);" />
