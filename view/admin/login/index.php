  ...
  <div class="login-box-body">
    ...
    <form action="" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="login" class="btn bg-navy margin">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
       <a href="javascript:void(0)" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign in using Google+</a>
    ...
    <a href="view/admin/login/fpass.php">Forgot Password</a><br>
