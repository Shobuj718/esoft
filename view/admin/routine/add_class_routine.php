  ...
  <div class="container" style="width: 100%; background: white">
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <form action="view/admin/routine/store_class_routine.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add New Class Routine</h3>
                <hr /> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for=""> Class Routine :<font color="red" size="4">*</font> </label>
                            <input type='text' id="" name="routine" class="form-control" placeholder="Enter New Routine" required />
                        </div>
                    </div>  
                </div>
                <div class="row">
