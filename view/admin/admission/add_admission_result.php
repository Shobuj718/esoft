  ...
  <div class="container" style="width: 100%; background: white">
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <form action="view/admin/admission/store_admission_result.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add New Admission Result</h3>
                <hr /> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">New Result :<font color="red" size="4">*</font> </label>
                            <input type='text' id="" name="news" class="form-control" placeholder="Enter New Result" required />
                        </div>
                    </div>  
                </div>
                <div class="row">
