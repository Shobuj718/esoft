  ...
  <div class="container" style="width: 100%; background: white">
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <form action="view/admin/admission/store_admission.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add New Admission Notice</h3>
                <hr /> 
                <div class="row">
                    <div class="col-md-6">
