  ...
  <div class="container" style="width: 100%; background: white">
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <form action="view/admin/admission/store_guideline.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add New Guideline </h3>
                <hr /> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Guideline Notice :<font color="red" size="4">*</font> </label>
