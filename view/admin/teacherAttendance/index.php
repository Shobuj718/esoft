  ...
  <div class="row">
    ...
    <div class="box-body table-responsive no-padding">
        <table class="table table-bordered table-responsive" style="background: white">
            ...
            <tr>
                <td colspan="12" style="color:green;"><h2><center> Other Front value Set here...comming...</center></h2> 
                <?php echo "<hr>" ?>
                </td>
            ...
            foreach ($results as $result) {
                ...
                <tr class="text-left">
                    ...
                    <td><input type="hidden" name="index" value="<?php echo $result['index_number']?>"> <?php echo $result['index_number']?></td>
