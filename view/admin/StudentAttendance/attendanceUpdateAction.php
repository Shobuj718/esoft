...
echo "<pre>";
var_dump($_POST);*/
$attendance->otherway($attend, $class, $branch, $department, $dateselect);

//$result = $attendance->set($_POST)->UpdateTaken($attend, $class, $branch, $department, $dateselect);
/*
echo "<pre>";
var_dump($result);
die();*/
