...
$result = $attendance->set($_POST)->AlreadyTaken($attend, $class, $shift, $branch, $department);
/*echo "<pre>";
var_dump($result);
die();*/

//$attendance->StudentAttend($attend, $class, $shift, $branch, $department);
...
/*if($result){
    ...
    $_SESSION['attTake'] = "Student Attendance Error... ";
            echo "<script>window.location='view/admin/StudentAttendance/searchForTakeAttendance.php</script>";
}
*/
