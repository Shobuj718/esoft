<?php 
namespace App\Admin\Institution;
if(!isset($_SESSION)){  
  session_start();
}
use PDO;
...
class Institution extends Connection{
	...
	public function insert(){
		...
		if(empty($this->image)){
			$query = $this->con->prepare("insert into institution (institution_name,village,post_office,thana,district,history,unique_id,created_at) values(:institution_name,:village,:post_office,:thana,:district,:history,:unique_id,:created_at)");
			...
			$query = $this->con->prepare("insert into institution (institution_name,village,post_office,thana,district,history,image,unique_id,created_at) values(:institution_name,:village,:post_office,:thana,:district,:history,:image,:unique_id,:created_at)");
	...
	public function update(){
		...
		if(empty($this->image)){
			...
			$query = $this->con->prepare("update institution set institution_name=:institution_name,village=:village,post_office=:post_office,thana=:thana,district=:district,history=:history,updated_at=:updated_at where status=:status and unique_id=:id");
			...
			$query = $this->con->prepare("update institution set institution_name=:institution_name,village=:village,post_office=:post_office,thana=:thana,district=:district,history=:history,image=:image,updated_at=:updated_at where status=:status and unique_id=:id"); 
