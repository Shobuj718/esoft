...
class Book extends Connection{
	...
	public function insert(){
		...
		$query = $this->con->prepare("insert into book (name,writer,unique_id,created_at) values(:name,:writer,:unique_id,:created_at)");
	...
	public function view(){
		$query = $this->con->prepare("select * from book where status=:status order by id desc");
